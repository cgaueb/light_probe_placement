...
public class GeneratorNavMeshVolume : GeneratorInterface
{
    ...
    private LumibricksScript script = null;
    #endregion

    #region Constructor Functions
    public GeneratorNavMeshVolume(LumibricksScript script, NavMeshAgent navMeshAgent) : base(LumibricksScript.PlacementType.NavMeshVolume.ToString()) {
        this.script = script;
